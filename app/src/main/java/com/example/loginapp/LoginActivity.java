    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(validateFields())
                {
                    if(myPrefs.getMobile().equals(binding.etMobile.getText().toString()) && myPrefs.getPassword().equals(binding.etPassword.getText().toString()))
                    {
                        myPrefs.setIsLoggedIn(true);
